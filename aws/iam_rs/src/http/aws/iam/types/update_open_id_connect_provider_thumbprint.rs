...
impl validators::NamedValidator for &UpdateOpenIdConnectProviderThumbprintRequest {
    fn validate(&self, at: &str) -> Result<(), validators::ValidationError> {
        ...
        validators::validate_required(self.thumbprint_list(), format!("{at}.{}", "ThumbprintList").as_str())?;
