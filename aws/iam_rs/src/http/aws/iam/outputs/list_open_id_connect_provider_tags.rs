...
pub type LocalListOpenIdConnectProviderTagsOutput = OutputWrapper<ListOpenIdConnectProviderTagsOutput>;

impl From<LocalListOpenIdConnectProviderTagsOutput> for XmlResponse {
    fn from(val: LocalListOpenIdConnectProviderTagsOutput) -> Self {
