...
impl From<LocalAssumeRoleOutput> for XmlResponse {
    fn from(val: LocalAssumeRoleOutput) -> Self {
        ...
        if val.inner.assumed_role_user().is_some() {
            ...
            xml::write_tag_with_value(&mut assume_role_user_tag, "Arn", Some(assumed_role_user.arn()));
        ...
        xml::write_tag_with_value(&mut response_metadata_tag, "RequestId", Some(val.request_id));
