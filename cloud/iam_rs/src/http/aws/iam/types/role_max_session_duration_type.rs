...
impl validators::NamedValidator for &RoleMaxSessionDurationType {
    fn validate(&self, at: &str) -> Result<(), validators::ValidationError> {
        validators::validate_min(Some(self.0), 3600i32, at)?;
        validators::validate_max(Some(self.0), 43200i32, at)?;
        Ok(())
    }
}
...
impl<'de> Deserialize<'de> for RoleMaxSessionDurationType {
        ...
        D: Deserializer<'de>,
    {
        ...
        buf.parse::<i32>()
            .map(RoleMaxSessionDurationType)
