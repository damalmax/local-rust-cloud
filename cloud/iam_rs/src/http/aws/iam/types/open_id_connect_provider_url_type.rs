...
use validators::{validate_str_length_max, validate_str_length_min, ValidationError, ValidationErrorKind};
...
impl validators::NamedValidator for &OpenIdConnectProviderUrlType {
