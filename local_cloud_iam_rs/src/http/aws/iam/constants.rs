...
pub(crate) mod arn {
    pub(crate) const ARN_MIN_SIZE: usize = 20;
    pub(crate) const ARN_MAX_SIZE: usize = 2048;
}
...
pub(crate) mod policy {
    ...
    pub(crate) const POLICY_NAME_MAX_SIZE: usize = 128;
    pub(crate) const POLICY_NAME_MIN_SIZE: usize = 1;
    pub(crate) const POLICY_DESCRIPTION_MAX_SIZE: usize = 1000;
    pub(crate) const PATH_MAX_SIZE: usize = 512;
    pub(crate) const ROLE_NAME_MAX_SIZE: usize = 64;
...
pub(crate) mod tag {
    ...
    pub(crate) const TAG_KEY_MIN_SIZE: usize = 1;
    pub(crate) const TAG_KEY_MAX_SIZE: usize = 128;

    pub(crate) const TAG_VALUE_MAX_SIZE: usize = 256;
