...
pub(crate) struct ContextEntry {
    ...
    pub(crate) context_key_values: Option<
        Vec<types::context_key_value_type::ContextKeyValueType>,
    >,
    #[serde(rename = "ContextKeyName")]
    pub(crate) context_key_name: Option<
        types::context_key_name_type::ContextKeyNameType,
    >,
    #[serde(rename = "ContextKeyType")]
    pub(crate) context_key_type: Option<
        types::context_key_type_enum::ContextKeyTypeEnum,
    >,
}
impl ContextEntry {
    pub(crate) fn context_key_values(
        &self,
    ) -> Option<&[types::context_key_value_type::ContextKeyValueType]> {
        self.context_key_values.as_deref()
    }
    pub(crate) fn context_key_name(&self) -> Option<&str> {
        self.context_key_name.as_deref()
    }
    pub(crate) fn context_key_type(
        &self,
    ) -> Option<&types::context_key_type_enum::ContextKeyTypeEnum> {
