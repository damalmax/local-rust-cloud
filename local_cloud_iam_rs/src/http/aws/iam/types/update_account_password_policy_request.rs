...
pub(crate) struct UpdateAccountPasswordPolicyRequest {
    ...
    pub(crate) password_reuse_prevention: Option<
        types::password_reuse_prevention_type::PasswordReusePreventionType,
    >,
    #[serde(rename = "MaxPasswordAge")]
    pub(crate) max_password_age: Option<
        types::max_password_age_type::MaxPasswordAgeType,
    >,
    #[serde(rename = "MinimumPasswordLength")]
    pub(crate) minimum_password_length: Option<
        types::minimum_password_length_type::MinimumPasswordLengthType,
    >,
}
impl UpdateAccountPasswordPolicyRequest {
    pub(crate) fn require_lowercase_characters(
        &self,
    ) -> Option<&local_cloud_common::types::Bool> {
        self.require_lowercase_characters.as_ref()
    }
    pub(crate) fn allow_users_to_change_password(
        &self,
    ) -> Option<&local_cloud_common::types::Bool> {
        self.allow_users_to_change_password.as_ref()
    }
    pub(crate) fn require_numbers(&self) -> Option<&local_cloud_common::types::Bool> {
        self.require_numbers.as_ref()
    }
    pub(crate) fn hard_expiry(&self) -> Option<&local_cloud_common::types::Bool> {
        self.hard_expiry.as_ref()
    }
    pub(crate) fn require_symbols(&self) -> Option<&local_cloud_common::types::Bool> {
        self.require_symbols.as_ref()
    }
    pub(crate) fn require_uppercase_characters(
        &self,
    ) -> Option<&local_cloud_common::types::Bool> {
        self.require_uppercase_characters.as_ref()
    }
