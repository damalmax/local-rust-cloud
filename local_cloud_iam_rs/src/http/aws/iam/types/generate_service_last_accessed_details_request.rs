...
pub(crate) struct GenerateServiceLastAccessedDetailsRequest {
    ...
    pub(crate) granularity: Option<
        types::access_advisor_usage_granularity_type::AccessAdvisorUsageGranularityType,
    >,
}
...
for &GenerateServiceLastAccessedDetailsRequest {
