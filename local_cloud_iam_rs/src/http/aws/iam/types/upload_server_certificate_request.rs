...
pub(crate) struct UploadServerCertificateRequest {
    ...
    pub(crate) certificate_chain: Option<
        types::certificate_chain_type::CertificateChainType,
    >,
    #[serde(rename = "Path")]
    ...
    pub(crate) certificate_body: Option<
        types::certificate_body_type::CertificateBodyType,
    >,
}
