...
pub(crate) struct InstanceProfileNameType(String);
impl Deref for InstanceProfileNameType {
    type Target = str;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl local_cloud_validate::NamedValidator for &InstanceProfileNameType {
