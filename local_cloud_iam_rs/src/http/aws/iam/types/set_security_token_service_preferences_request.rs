...
pub(crate) struct SetSecurityTokenServicePreferencesRequest {
    ...
    pub(crate) global_endpoint_token_version: Option<
        types::global_endpoint_token_version::GlobalEndpointTokenVersion,
    >,
}
...
for &SetSecurityTokenServicePreferencesRequest {
