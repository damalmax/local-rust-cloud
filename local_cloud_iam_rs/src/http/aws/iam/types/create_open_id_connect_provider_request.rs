...
pub(crate) struct CreateOpenIdConnectProviderRequest {
    ...
    pub(crate) url: Option<
        types::open_id_connect_provider_url_type::OpenIdConnectProviderUrlType,
    >,
...
impl CreateOpenIdConnectProviderRequest {
    ...
    pub(crate) fn client_id_list(
        &self,
    ) -> Option<&[types::client_id_type::ClientIdType]> {
