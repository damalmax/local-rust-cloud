...
pub(crate) struct ListVirtualMfaDevicesRequest {
    ...
    pub(crate) assignment_status: Option<
        types::assignment_status_type::AssignmentStatusType,
    >,
    #[serde(rename = "Marker")]
...
impl ListVirtualMfaDevicesRequest {
    ...
    pub(crate) fn assignment_status(
        &self,
    ) -> Option<&types::assignment_status_type::AssignmentStatusType> {
